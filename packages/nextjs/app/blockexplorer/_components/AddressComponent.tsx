...
export const AddressComponent = ({
  ...
  return (
    <div className="m-10 mb-20 min-h-screen bg-[#0F0F0F] text-white">
      <div className="flex justify-start mb-5">
        <BackButton />
      </div>
      <div className="col-span-5 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10">
        <div className="col-span-1 flex flex-col">
          <div className="bg-[#1A1A1A] border-gray-700 border shadow-md rounded-3xl px-6 lg:px-8 mb-6 space-y-1 py-4 overflow-x-auto text-white">
            <div className="flex">
