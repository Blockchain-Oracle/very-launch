      ...
      <div className="relative z-10 flex flex-col justify-start items-center gap-9 max-w-4xl mx-auto">
        <div className="flex flex-col justify-start items-center gap-4 text-center mt-10 sm:mt-0">
          <h2 className="text-foreground text-4xl md:text-5xl lg:text-[68px] font-semibold leading-tight md:leading-tight lg:leading-[76px] break-words max-w-[435px]">
            Launchpads built for Very Network
          </h2>
          <p className="text-muted-foreground text-sm md:text-base font-medium leading-[18.20px] md:leading-relaxed break-words max-w-2xl">
            VeryLaunch is more than a launchpad — it&apos;s an ecosystem. From bonding curve launches to instant
            liquidity on Very Network, from OG Points rewards to campaign sponsorships, we&apos;re redefining fair and
            sustainable token launches.
          </p>
        </div>
        <Link
          href={"/app"}
          className="px-10 py-4 rounded-full bg-[#FF6B7A] text-white font-normal text-md transition-all duration-300 hover:bg-[#FF8B7A] cursor-pointer h-12 flex items-center z-10"
        >
          Get Started
        </Link>
      </div>
